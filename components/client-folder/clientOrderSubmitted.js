            ...
            <div className="client_body_wrapper flex_show_row">
                <div className="client_order_left">
                    ...
                    <div className="order_overview_body">
                        ...
                        <div className="client_creator_comment">
                            <div className="client_creator_header flex_show_row">
                                <div className="buyers_comment_row flex_show_row">
                                    <div className="client_creator_avatar">
                                        <img src="img/category.png" alt=""/>
                                    </div>
                                    <div className="client_creator_content remove_margin">
                                        <p>Buyers Name, left Feedback</p>
                                        <p>October 2, 2021</p>
                                    </div>
                                </div>
                                <div className="order_review_container flex_show_row remove_margin">
                                    <img src="svg/Chat_outline.svg" alt=""/>
                                    <p>Order Reviews</p>      
                                </div>
                            </div>
                            <div className="client_creator_comment_body">
                                <div className="delivery_chat_message">
                                    <div className="buyer_recommendation_row">
                                        <p>
                                            Excellent designer. Communication was an issue at first but this was solved very quickly by revisions. Thanks so much! Professional skills and very good eye for design.
                                        </p>
                                        <div className="recommend_order flex_show_row remove_margin">
                                            <img src="svg/thumb_up.svg" alt=""/>
                                            <p>Recommended</p>
                                        </div>
                                        <div className="share_post_response border flex_show_row">
                                            <div className="share_review flex_show_row remove_margin">
                                                <img src="svg/share_outline.svg" alt=""/>
                                                <p>Share reviews</p>
                                            </div>
                                            <div className="share_review remove_margin">
                                                <p>Post a rsesponse</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="chat_message_wrapper flex_show_row">
...
export default ClientOrderSubmitted